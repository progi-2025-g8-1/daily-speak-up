<template>
  <div class="flex items-center gap-6">
    ...
    <div v-else-if="displayUser" class="flex flex-row justify-around w-full">
      <Avatar 
...
export default {
  ...
  props: {
    ...
    friendshipStatus: {
      type: String,
      default: null // 'accepted', 'pending_outgoing', 'pending_incoming', 'denied', null
    }
  },
  setup(props, { emit }) {
    const user = ref(null);
    ...
    // Može vidjeti prijatelje ako je vlastiti profil ili ako su prijatelji
